         ...
         <form action="" method="post" enctype="multipart/form-data">
            <table class="form">
                ...
                <tr>
                    ...
                    <td>
                        <img src="<?php echo $value['image'];?>" height="60px" width="200px"/></br>
				...
				<tr>
                    ...
                    <td>
                        <select id="select" name="type">
                            ...
                            <?php 
                            if($value['type']==0){
                                echo "<option selected='selected' value='0'>Featured</option>";
                                echo "<option  value='1'>General</option>";
                            }else{
                                echo "<option selected='selected' value='1'>General</option>";
                                 echo "<option  value='0'>Featured</option>";
                            }
                            ?>
